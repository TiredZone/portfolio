...
description: "Deep-dive into my greatest CRO victories at BAD Marketing: 52% revenue growth, 22% conversion boost, 9.31% peak CR, and more across 8+ DTC brands. Real data, real impact."
...
### 1. DTC Skincare Brand - Complete Site Transformation (November 2022)

**The Challenge**
This DTC skincare brand had been running a free + shipping offer since 2021 but struggled with full-price product conversions after launching paid products in early 2022. Their website wasn't optimized for their target demographic.
...
### 2. Health & Wellness Brand - Critical Bug Fix (2023)

**The Challenge**
This health & wellness brand revamped their subscribe & save program with a new app, resulting in steadily declining conversion rates despite testing page design, copy, and graphics.
...
### 3. Supplement Brand - Peak Performance Achievement (2023)

**The Challenge**
This supplement brand faced unique constraints with their best-seller undergoing advertising limitations. We needed to optimize conversions while being careful not to trigger additional ad restrictions.
...
### 4. Luxury Home Brand - Upsell Excellence (December 2022)
...
> "MEGA DUB for the CRO/Web Dev Team! Full price product purchases: Increased by 52.59%, Full Price Product Revenue: Increased by 79.60%"
...
## Career Arc: From CRO Developer to Systems Architect

My journey at BAD Marketing began in September 2022 as a Web Developer focused on Shopify CRO. Over three years, the role evolved from implementing conversion optimizations to architecting enterprise-grade systems -- culminating in a promotion to **Advanced Systems & Operations Developer** in September 2025, a role created specifically for my unique blend of CRO expertise and systems thinking.

### The Evolution Timeline

**Phase 1: CRO Foundations (Sep 2022 - Mid 2023)**
The initial period was defined by the victories detailed above -- proving that deep technical skill combined with business understanding could drive measurable revenue outcomes. The DTC Skincare Brand rebuild, the Health & Wellness bug fix, and the Luxury Home upsell system established credibility and demonstrated consistent delivery.

**Phase 2: Technical Leadership (Mid 2023 - Aug 2025)**
As the wins accumulated, my scope expanded beyond individual brand optimizations. I began driving infrastructure improvements that benefited the entire agency:

- **Advanced GTM Template System**: Collaborated with Thomas Abboud to create comprehensive tracking templates covering Google Analytics, Facebook Pixel, Microsoft Clarity, upsell funnel events, and Recharge conversions -- streamlining client onboarding by 70%
- **Dynamic Theming Systems**: Built interactive product-specific theming for brands like Vitamina Gummies, where the entire site adapted its visual language based on the product being viewed
- **Documentation & Knowledge Management**: Drove clean-up of fragmented documentation, created single sources of truth for procedures, mentored teammates on development standards, and established code review best practices

**Phase 3: Systems Architecture (Sep 2025 - Present)**
The promotion marked a shift from tactical CRO execution to strategic systems thinking. I now build the infrastructure that powers BAD Marketing's operations at scale -- modular ETL platforms, multi-stage lead processing pipelines, production-grade ClickUp analytics, and CI/CD deployment infrastructure.

### Production Infrastructure Practices

The systems work brought a new set of engineering disciplines:

- **CI/CD Pipeline with GitHub Actions**: Containerized services with Docker, health checks, retries, idempotency, environment-safe secrets management, and zero-downtime deployments
- **Observability & Monitoring**: Centralized logging with structured JSON, error triage with automated Slack alerts, lightweight dashboards for KPI tracking, runbooks and incident playbooks
- **Security Hardening**: WordPress/Shopify security hardening (2FA, WAF), backup and restore procedures, disaster recovery testing, and security audit documentation

### Advanced Analytics Implementation

The CRO work naturally led to building more sophisticated analytics infrastructure:
...
This GA4 and server-side tracking implementation ensures trustworthy A/B test results, proper 5-day attribution window implementation, cross-platform revenue reconciliation, and real-time experiment monitoring -- directly supporting the CRO work that defines my impact.

### Cumulative Impact Across 3+ Years

The numbers tell the story of consistent, compounding value creation:

- **$500K+ in incremental revenue** generated through CRO across multiple brands
- **15+ production automation pipelines** built and running
...
Multiple team recognitions highlighting sustained impact:

> "You two are the definition of #extremeownership and #solutionsnotproblems"

> "HUGE (and I mean GIGANTIC) shout out to @Ignacio Nunez @Bechara Maalouf and @Thomas Abboud for building out the entire new site and making it fast, beautiful and easy to navigate."

The 3+ year partnership demonstrates consistent delivery from day-one CRO wins through enterprise system architecture, a growth mindset that evolved from implementation to strategic technical leadership, and a deep understanding of agency operations that ensures every technical decision ties back to business value.
